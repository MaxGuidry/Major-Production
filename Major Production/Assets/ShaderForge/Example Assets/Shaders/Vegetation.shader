    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float3 node_394 = (normalize((float3(0,0,0)+v.normal))*o.vertexColor.r*sin(((o.vertexColor.b*3.141592654)+node_392.a))*0.016); // Wind animation
...
////// Emissive:
                float4 node_392 = _Time;
                float3 node_394 = (normalize((float3(0,0,0)+i.normalDir))*i.vertexColor.r*sin(((i.vertexColor.b*3.141592654)+node_392.a))*0.016); // Wind animation
